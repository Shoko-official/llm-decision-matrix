...
```text
docs/matrix/<issue-id>-short-name
feat/matrix/<issue-id>-short-name
fix/matrix/<issue-id>-short-name
```
...
* no decision matrix content appears before the right milestone;
...
Do not introduce decision criteria as final content unless they are backed by
approved research ledger or taxonomy material.
